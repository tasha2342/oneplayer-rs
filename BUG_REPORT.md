...
- 작성일: 2026-07-09
- 대상 로그: 2026-07-08 08:31 ~ 08:40 (OnePlayerWin)
...
| `crates/render/src/scene/mod.rs` | prepare 전 영상 파일 존재 검증 (ffmpeg 스폰 전 차단) |
| `crates/render/src/video/mod.rs` | `open()` 입력 파일 존재 검증 (ENOENT를 hwaccel 폴백에서 분리) |
